...
const sampleCars = [
  {
    ...
    name: "Truck Titan",
    brand: "Nissan",
    type: "PICKUP", // Adjusted to match your CarType enum
    year: 2019,
    mileage: 45000,
    colors: ["Gray", "Black"],
    price: 25800.0,
    ...
    images: [
      "https://example.com/nissan_truck_titan_1.jpg",
      "https://example.com/nissan_truck_titan_2.jpg",
    ],
    userId: "user789",
    isSold: false,
    isFeatured: false,
  ...
  },
  {
    ...
    colors: ["White", "Black"],
    price: 42999.99,
    description: "Fully electric and sleek design with autopilot.",
    images: [
      "https://example.com/tesla_model3_1.jpg",
      "https://example.com/tesla_model3_2.jpg",
    ],
    userId: "user123",
    isSold: false,
    isFeatured: true,
  ...
  },
  {
    ...
    colors: ["Red"],
    price: 20500.0,
    description: "Compact and reliable car with sporty features.",
    images: [
      "https://example.com/honda_civic_hatchback_1.jpg",
      "https://example.com/honda_civic_hatchback_2.jpg",
    ],
    userId: "user456",
    isSold: false,
    isFeatured: false,
    isNew: false,
    features: ["Turbo Engine", "Rear Camera", "Heated Seats"],
    location: "Chicago, IL",
    fuelType: "PETROL",
    transmission: "MANUAL",
    createdAt: new Date(),
